...
class SparseSFProvider {
 public:
  ...
  virtual void ComputeSparseSF(const ViewPair &last_view, const ViewPair &current_view,
                               std::vector<instreclib::segmentation::InstanceDetection> &detections) = 0; //debug

  //------------------------------------------------------------------------------------------------

  //Added
  //For DEBUG
  SparseSceneFlow latest_flow_delete_;
  //-------------------------------------------------------------------------------------------------
