...
class InstanceTracker {
 private:
  ...
  //Added
  /// Tracked objects in the previous frame
  vector<int> trackedobjects_pre_;
 ...
 protected:
  ...
  std::pair<Track*, float> FindBestTrack(const TrackFrame& track_frame,float &areascore);
 ...
 public:
  ...
  void ProcessInstanceViews(
      ...
      cv::Mat input_hsv_left,//added
      cv::Mat input_hsv_right,//added
      VisualOdometryStereo::parameters my_sf_params,//added
      ITMLib::Objects::ITMView *main_view,//added
      const SparseSceneFlow &scene_flow//added
  );
